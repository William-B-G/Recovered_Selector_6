...
/* FOR SELECTOR 6 FIXTURE TEST DO NOT ALTERNATE, ONLY CALL ctcan_control()	   
// Alternate from servicing MR CAN and CTCAN    
	if (alt_can == 1)
	{
		alt_can = 0;
...
*/	
	ctcan_control(); // FOR SELECTOR 6 FIXTURE TEST DO NOT ALTERNATE, ONLY CALL ctcan_control()
