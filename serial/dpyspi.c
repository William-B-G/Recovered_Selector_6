...
void load_special_char (void)
{ // For Spinner in Generic_1132_based_tester
// tagwbg 17
	...
	put_dpyspi_data(0x54);		// Load Special Character Set command
	put_dpyspi_data(0x00);		// character address 
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x00);		
	...
	put_dpyspi_data(0x01);		// character address 
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x01);		
	put_dpyspi_data(0x02);		
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x00);		
	...
	put_dpyspi_data(0x00);		
	put_dpyspi_data(0x04);		
	put_dpyspi_data(0x08);		
	put_dpyspi_data(0x10);		
	put_dpyspi_data(0x00);		
