...
#define MAX_GENERIC_TEST 20
#define MAX_TEST_DEFINED 15
#define ABORT 0x2000 // Turn off all IO's even if structure says to leave them on
...
#define DELAY_3 3
#define DELAY_10s 100
#define DELAY_5s 50
#define DELAY_3s  30
#define MAX_COP_out_index 5
#define YES 1
#define NO 0
#define ALLOW_SUB_4_READ_ALL 1
#define SUB_INITIAL_4_READ_ALL 0
#define SUB_FINAL_4_READ_ALL 0x2
...
extern int16 msg_29_Rx;
extern int16 Global_Allow_Retest;
extern int16 Read_All_inputs_Control_byte;
extern int16 GenericTest_index;
extern int16 Dyn_var_1 ;
extern int16 Dyn_var_2 ;
extern int16 Dyn_var_3 ;
extern int16 Dyn_var_4 ;
extern int16  APS_delta;
...
extern int16 Display_hint_msgs(int16 Test);
...
extern int16 Evaluate_The_Results(uint32 The_Expected_Pattern, uint16 Which_IO_and_Options );
...
extern int16 Insert_Remove_Jumper(int16 Jumper_plus_state);
extern void Clear_Button_Pressed_Array(void);
...
extern void pack_util_ctcan(unsigned char msg, unsigned char devnmb,unsigned char tx_req, unsigned char len, unsigned char one_tx);
...
extern int16 Set_or_clear_OPL_PWR(int16 On_Off);
...
extern int16 Construct_Msg_28(int16 Door_Command);
int16 Write_msg_29_data_to_msg_board_A(int16 TheTest);
extern int16 Dsply_Msg_29_Return(int16 Params_and_Which_test);
extern int16 Front_Door_Test(int16 params);
extern int16 Rear_Door_Test(int16 params);
extern int16 ctCAN_BAUD(int16 Which_Rate);
...
extern uint32 Testing_via_substitution(int16 Read_All_inputs_Control_byte_param);
extern int16 Generic_2_montr_a_grp_of_4_Vars(int16 which_grp_of_vars);
extern int16 Dynamic_montr_a_grp_of_4_Vars(int16 which_grp_of_vars);
extern int16 Run_3_tsts_together(int16 dummy);
extern int16 Run_APS_tst(int16 dummy);
extern int16 Run_DTS_UTS_tst(int16 dummy);
extern int16 Run_DTS_tst(int16 dummy);
extern int16 Run_UTS_tst(int16 dummy);
extern int16 Run_SPI_CAN_tst(int16 Options);
