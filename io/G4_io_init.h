...
// WBG 2019-1-06 FOR SELECTOR 6 TEST FIXTURE
extern struct io si_DTS;  // Connected via GRCAN to SEB
extern struct io si_UTS;  // Connected via GRCAN to SEB
