...
// (2) wbg 2018-9-02 OPL-0106N
	...
	init_io(O_PWR,CTCAN,  "  PWR",0x11,NoLight);	
...
*/	
	init_gio(i_GRi0,GRCAN," GRi0",0x10);
	init_gio(i_GRi1,GRCAN," GRi1",0x10);
	init_gio(i_GRi2,GRCAN," GRi2",0x10);
	init_gio(i_GRi3,GRCAN," GRi3",0x10);
	init_gio(i_GRi4,GRCAN," GRi4",0x10);
	init_gio(i_GRi5,GRCAN," GRi5",0x10);
	init_gio(i_GRi6,GRCAN," GRi6",0x10);
	init_gio(i_GRi7,GRCAN," GRi7",0x10);
	init_gio(i_GRi8,GRCAN," GRi8",0x10);
	init_gio(i_GRi9,GRCAN," GRi9",0x10);
	init_gio(i_GRi10,GRCAN,"GRi10",0x10);
	init_gio(i_GRi11,GRCAN,"GRi11",0x10);
...
// WBG 2019/1/5 GRCAN
 	//CAN Add 12, dip switch setting 2
 	//input
//	init_gio(i_GRi0,GRCAN,"DTSi ",0x10);
//	init_gio(i_GRi1,GRCAN,"UTSi ",0x10);
	init_gio(i_DTS,GRCAN,"DTSi ",0x10);
	init_gio(i_UTS,GRCAN,"UTSi ",0x10) ;
	...
	// input
	init_gio(i_SWi0,GRCAN," SWi0",0x10);
	init_gio(i_SWi1,GRCAN," SWi1",0x10);
	init_gio(i_SWi2,GRCAN," SWi2",0x10);
	init_gio(i_SWi3,GRCAN," SWi3",0x10);
	init_gio(i_SWi4,GRCAN," SWi4",0x10);
	init_gio(i_SWi5,GRCAN," SWi5",0x10);	
	
	// output
	init_gio(O_LDO6, GRCAN," LDO6",0x11);
	init_gio(O_LDO7, GRCAN," LDO7",0x11);
	init_gio(O_LDO8, GRCAN," LDO8",0x11);
	init_gio(O_LDO9, GRCAN," LDO9",0x11);
	init_gio(O_LDO10,GRCAN,"LDO10",0x11);
	init_gio(O_LDO11,GRCAN,"LDO11",0x11);			
